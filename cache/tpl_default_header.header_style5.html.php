<?php if (!defined('IN_PHPMEGATEMP')) exit; ?><header class="header5" id="header">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="links">
                    <li><a href="tel:<?php echo (isset($this->_rootref['THOP_PHONE'])) ? $this->_rootref['THOP_PHONE'] : ''; ?>"><i class="pe-7s-call"></i><span><?php echo (isset($this->_rootref['THOP_PHONE'])) ? $this->_rootref['THOP_PHONE'] : ''; ?></span></a></li>
                    <li><a href="mailto:<?php echo (isset($this->_rootref['THOP_EMAIL'])) ? $this->_rootref['THOP_EMAIL'] : ''; ?>"><i class="pe-7s-mail"></i><span><?php echo (isset($this->_rootref['THOP_EMAIL'])) ? $this->_rootref['THOP_EMAIL'] : ''; ?></span></a></li>
                </ul>
            </div>
        </div>
        <div class="row">
